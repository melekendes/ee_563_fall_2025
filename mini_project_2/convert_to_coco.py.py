...
def convert_balloon_to_coco(ann_file, out_file, image_prefix):
    ...
    for idx, v in enumerate(track_iter_progress(list(data_infos.values()))):
        ...
        height, width = mmcv.imread(img_path).shape[:2] #automatically gets real height and width
        ...
        for _, obj in v['regions'].items():
            ...
            data_anno = dict(
                ...
                id=obj_count,
                category_id=0,
                bbox=[x_min, y_min, x_max - x_min, y_max - y_min], #bbox calculate
